LSTMTrainFilename = fopen('C:\Users\suraiya jabin\Documents\MATLAB\StartStopLstmModels13Apr_final\Test2\LSTM_Test2_13apr.txt','w');
...
base_dir2='C:\Users\suraiya jabin\Documents\MATLAB\StartStopLstmModels13Apr_final\Test2';
...
XTest(end+1:end+size(XTest3,1),1)=XTest3;
YTest(end+1:end+size(XTest3,1),1)=YTest3;
